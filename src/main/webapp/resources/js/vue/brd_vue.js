...
brd_vue = {
	...
	brd_body: x=>{
		...
		'        <img class="mr-3" src="/web/resources/img/wego.png" alt="" width="48" height="48">'+
		'        <div class="lh-100">'+
	    ...
	    '        <h6 class="border-bottom border-gray pb-2 mb-0">최근 UPDATE</h6>'+
		...
		'    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>'+
